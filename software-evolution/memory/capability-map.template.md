...
| Domain | Canonical term | Aliases/synonyms/UI labels | Notes |
|---|---|---|---|
| TBD | TBD | TBD | TBD |
...
| Rule/invariant | Canonical owner | Other implementations/readers | Consistency status | Tests/evidence | Debt ID |
|---|---|---|---|---|---|
| TBD | TBD | TBD | unknown | TBD | TBD |
